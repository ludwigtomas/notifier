...
class GitlabService
{
    ...
    public static function getRepositorylastCommit(Repository $repository): void
    {
        ...
        try {
            ...
            // TODO: refactor
            $create_date = $repository_api[0]->created_at ? Carbon::parse($repository_api[0]->created_at) : null;
    ...
    public static function getRepositoryAvatar(Repository $repository, $repository_api = null, $gitlab = null): void
    {
        $client = new GuzzleClient([
            'base_uri' => 'https://gitlab.com/api/v4/',
        ]);
