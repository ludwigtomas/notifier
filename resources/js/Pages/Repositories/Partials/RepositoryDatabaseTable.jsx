...
export default function RepositoryDatabaseTable({
    ...
    const toggleModal = (database_backups) => {
        setSelectedDatabases(database_backups);
    ...
    const deleteDatabase = () => {
        let url = route("backups.destroy", selectedDatabases.id);
        ...
        <div className="mt-10 border-4 border-zinc-900 divide-y rounded-lg divide-zinc-800 ">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ms-6">
                        <div className="ms-3 relative ">
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <Dropdown.Link className="border-l-4 border-transparent hover:border-red-500 hover:text-red-500">
                                        <span className="mr-2">
                                    ...
                                    <Dropdown.Link className="border-l-4 border-transparent hover:border-blue-500 hover:text-blue-500">
                                        <span className="mr-2">
                                            <BackspaceIcon className="w-6 h-6" />
                                        </span>
                                        <button onClick={deselectAllDatabases}>
                                            Odznačit vše
                                        </button>
                                    </Dropdown.Link>
                                </Dropdown.Content>
            ...
            <table className="min-w-full divide-y divide-zinc-700 rounded-md overflow-hidden">
                ...
                <tbody className="divide-y divide-zinc-700 bg-zinc-900">
                    {database_backups &&
                        database_backups.data.map((backup) => (
                            <tr
                                key={backup.id}
