...
export default function UpdateHostingInformationForm({ hosting, className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                ...
                <h2 className="text-lg font-medium text-gray-100">Hosting edit</h2>

                <p className="mt-1 text-sm text-gray-400">Update your hosting's information.</p>
            </header>
            ...
            >
                ...
                <div className="col-span-12 mt-6 flex items-center space-x-4">
                    ...
                    <div>
                        <GoBackLink href={route('hostings.index')}>Zpátky</GoBackLink>
                    </div>

                    {recentlySuccessful && <p className="text-green-500">Hosting information has been updated!</p>}
                </div>
            </form>
        </section>
    )
