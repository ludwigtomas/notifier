    ...
    return (
        <table className="min-w-full divide-y divide-zinc-700 overflow-hidden rounded-lg">
            ...
            <tbody className="divide-y divide-zinc-800 bg-zinc-700">
                {childrens.childrens &&
                    childrens.childrens.map((group, index) => {
                        return (
                            <tr
                                key={index}
                            ...
                            >
                                ...
                                <td className="px-4 py-4">
                                    <span
                                        className={`flex justify-center rounded-xl py-1 text-sm font-bold uppercase ${group.parent_id ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}`}
                                    >
                ...
                {repositories.repositories &&
                    repositories.repositories.map((repository) => {
                        return (
                            ...
                            >
                                <td className="px-4 py-4">
                                    <span className="text-sm font-medium text-zinc-200">{repository.repository_id}</span>
                                </td>
                                ...
                                <td className="px-4 py-4">
                                    <span className="text-sm font-medium text-zinc-200">{repository.slug}</span>
                                </td>
